...
[![Version](https://img.shields.io/github/v/release/iobee/agent-switch?color=blue&label=version)](https://github.com/iobee/agent-switch/releases)
[![Platform](https://img.shields.io/badge/platform-Windows%20%7C%20macOS%20%7C%20Linux-lightgrey.svg)](https://github.com/iobee/agent-switch/releases)
[![Built with Tauri](https://img.shields.io/badge/built%20with-Tauri%202-orange.svg)](https://tauri.app/)
[![Downloads](https://img.shields.io/github/downloads/iobee/agent-switch/total)](https://github.com/iobee/agent-switch/releases/latest)

<a href="https://trendshift.io/repositories/15372" target="_blank"><img src="https://trendshift.io/api/badge/repositories/15372" alt="farion1231%2Fcc-switch | Trendshift" style="width: 250px; height: 55px;" width="250" height="55"/></a>

### 🌐 The Only Official Website: **[github.com/iobee/agent-switch](https://github.com/iobee/agent-switch)**
...
Claude Code / Codex / Gemini official channels at 38% / 2% / 9% of original price, with extra discounts on top-ups! AICodeMirror offers special benefits for Agent Switch users: register via <a href="https://www.aicodemirror.com/register?invitecode=9915W3">this link</a> to enjoy 20% off your first top-up, and enterprise customers can get up to 25% off!</td>
</tr>
...
**Agent Switch** is a local desktop control plane for an AI API Gateway. It manages upstream providers, model routing, protocol adaptation, usage monitoring, and failover from one UI. You can add 50+ provider presets, switch models/providers from the app or tray, and rely on SQLite, atomic writes, and automatic backups to protect local config files.
...
- **Deep Link** (`agentswitch://`) — Import provider configurations via URL
- Dark / Light / System theme, auto-launch, auto-updater, atomic writes, auto-backups, i18n (zh/zh-TW/en/ja)

## FAQ

<details>
<summary><strong>Which AI tools does Agent Switch support?</strong></summary>

Agent Switch focuses on provider and model switching for **Claude Code**, **Claude Desktop**, **Codex**, **Gemini CLI**, **OpenCode**, **OpenClaw**, and **Hermes**. OpenClaw and Hermes are treated as provider targets, not separate agent-management surfaces.
...
Agent Switch for macOS is code-signed and notarized by Apple. You can download and install it directly — no extra steps needed. We recommend using the `.dmg` installer.
...
- **Database**: `~/.agent-switch/agent-switch.db` (SQLite — providers, Gateway state, usage, and configuration data)
- **Local settings**: `~/.agent-switch/settings.json` (device-level UI preferences)
- **Backups**: `~/.agent-switch/backups/` (auto-rotated, keeps 10 most recent)
...
```bash
brew install --cask agent-switch
```

Update:

```bash
brew upgrade --cask agent-switch
```
...
> **Note**: Agent Switch for macOS is code-signed and notarized by Apple. You can install and open it directly.
...
- **SSOT** (Single Source of Truth): All data stored in `~/.agent-switch/agent-switch.db` (SQLite)
...
[![Star History Chart](https://api.star-history.com/svg?repos=iobee/agent-switch&type=Date)](https://www.star-history.com/#iobee/agent-switch&Date)
