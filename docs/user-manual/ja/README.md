...
| ファイル | 内容 |
|------|------|
| [3.1-service.md](./4-proxy/4.1-service.md) | Gateway の起動、設定項目、実行状態 |
| [3.2-routing.md](./4-proxy/4.2-routing.md) | アプリケーションルーティング、設定変更、ステータス表示 |
| [3.3-failover.md](./4-proxy/4.3-failover.md) | フェイルオーバーキュー、サーキットブレーカー、ヘルスステータス |
| [3.4-usage.md](./4-proxy/4.4-usage.md) | 使用量統計、トレンドグラフ、料金設定 |
| [3.5-model-test.md](./4-proxy/4.5-model-test.md) | モデルテスト、ヘルスチェック、レイテンシテスト |
...
- **Gateway の使用**：[3.1 Gateway サービス](./4-proxy/4.1-service.md) をご確認ください
- **お困りの方**：[4.2 FAQ](./5-faq/5.2-questions.md) をご確認ください
