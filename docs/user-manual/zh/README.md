...
| 文件 | 内容 |
|------|------|
| [3.1-service.md](./4-proxy/4.1-service.md) | 启动 Gateway、配置项、运行状态 |
| [3.2-routing.md](./4-proxy/4.2-routing.md) | 应用路由、配置修改、状态指示 |
| [3.3-failover.md](./4-proxy/4.3-failover.md) | 故障转移队列、熔断器、健康状态 |
| [3.4-usage.md](./4-proxy/4.4-usage.md) | 用量统计、趋势图表、定价配置 |
| [3.5-model-test.md](./4-proxy/4.5-model-test.md) | 模型检查、健康检测、延迟测试 |
...
- **使用 Gateway**：查看 [3.1 Gateway 服务](./4-proxy/4.1-service.md)
...
- **用量看板筛选驱动 Hero**：展示缓存归一化后的真实总 token 与缓存命中率，并跟随日期 / 供应商 / 模型筛选实时更新 — 详见 [3.4 用量统计](./4-proxy/4.4-usage.md)
...
- **OpenCode / OpenClaw / Hermes 流式检测覆盖**：Stream Check 面板覆盖 Claude / Codex / Gemini / OpenCode / OpenClaw / Hermes — 详见 [3.5 模型检查](./4-proxy/4.5-model-test.md)
