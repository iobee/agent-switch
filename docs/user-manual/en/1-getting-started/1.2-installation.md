...
Only download Agent Switch from **[github.com/iobee/agent-switch](https://github.com/iobee/agent-switch)**, **[GitHub Releases](https://github.com/iobee/agent-switch/releases)**, or the project source repository. Any "Agent Switch" site or client that asks for payment, top-ups, or login credentials is not official.
...
1. Visit the [Releases page](https://github.com/iobee/agent-switch/releases)
...
Agent Switch for macOS is signed and notarized by Apple. You can install and open it directly — no extra steps needed.
...
- Optional: Delete the configuration directory `~/.agent-switch/`
