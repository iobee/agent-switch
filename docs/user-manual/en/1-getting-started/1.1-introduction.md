...
CC Switch is a cross-platform desktop application for developers who use AI coding tools. It provides a local AI API Gateway console for managing providers, models, routing, and usage across **Claude Code**, **Claude Desktop**, **Codex**, **Gemini CLI**, **OpenCode**, **OpenClaw**, and **Hermes**.
