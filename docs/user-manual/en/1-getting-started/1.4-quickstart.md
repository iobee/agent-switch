...
- [Enable Gateway service](../4-proxy/4.1-service.md) - Monitor usage and enable automatic failover
- [Configure failover](../4-proxy/4.3-failover.md) - Set backup providers for critical clients
- [View usage statistics](../4-proxy/4.4-usage.md) - Track tokens, cost, errors, and latency
