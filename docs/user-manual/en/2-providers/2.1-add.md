...
- Create using the [online generator tool](https://iobee.github.io/agent-switch/deplink.html)
...
> **Note**: Importing will overwrite the existing database. It is recommended to export your current configuration as a backup first. The exported file name format is `agent-switch-export-{timestamp}.sql`.
