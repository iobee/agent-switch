...
Agent Switch for macOS is code-signed and notarized by Apple. You can download and install it directly without any additional steps. If you encounter issues, try downloading the latest version from the [Releases page](https://github.com/iobee/agent-switch/releases).
...
**Solutions**:
1. Check if the `~/.agent-switch/` directory exists
2. Restore from backup: `~/.agent-switch/backups/`
...
2. Restart the app
3. Delete `~/.agent-switch/settings.json` to reset settings
...
3. If using Homebrew: `brew upgrade --cask agent-switch`
...
1. Visit [GitHub Issues](https://github.com/iobee/agent-switch/issues)
...
- macOS/Linux: `~/.agent-switch/logs/`
- Windows: `%APPDATA%\agent-switch\logs\`
