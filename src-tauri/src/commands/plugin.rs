...
pub async fn apply_claude_onboarding_skip() -> Result<bool, String> {
    crate::claude_user_config::set_has_completed_onboarding().map_err(|e| e.to_string())
}
...
pub async fn clear_claude_onboarding_skip() -> Result<bool, String> {
    crate::claude_user_config::clear_has_completed_onboarding().map_err(|e| e.to_string())
}
