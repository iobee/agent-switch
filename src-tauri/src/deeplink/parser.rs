...
//!
//! Parses agentswitch:// URLs into DeepLinkImportRequest structures.
...
/// Parse an agentswitch:// URL into a DeepLinkImportRequest
///
/// Expected format:
...
pub fn parse_deeplink_url(url_str: &str) -> Result<DeepLinkImportRequest, AppError> {
    ...
    if scheme != "agentswitch" {
        return Err(AppError::InvalidInput(format!(
            "Invalid scheme: expected 'agentswitch', got '{scheme}'"
        )));
    }
